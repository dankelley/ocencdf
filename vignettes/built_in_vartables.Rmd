...
This vignette discusses two built-in variable-table files.  These may be used as
patterns by users wishing to create their own tables.  Note that the package
