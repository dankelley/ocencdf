...
Note that you may also use the more basic function `ncdf2oce()` instead of
`ncdf2ctd()`, but if you do that, then `summary()` won't display location
information, and won't parse the `_QC` items as flags.
