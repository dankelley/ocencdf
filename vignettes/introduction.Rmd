...
reader.  Note that the column names are e.g. `TEMP` in the NetCDF file, because
the varTable named `"argo"` establishes that nickname.

In R, we can read `stn.nc` into a ctd object and get a summary with the
following.
